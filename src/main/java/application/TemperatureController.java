...
public class TemperatureController implements Initializable {
    ...
    public void addToTable(int points, int temperature, String datetime) {
        TableContents tablecontent = new TableContents(points,temperature,datetime);
    ...
    public String[] parseRow(String responseJson) {
        ...
        if (responseJson != null) {
            ...
            try {
                ...
                res[1] = json.get("temperature").toString();
