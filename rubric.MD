...
* [ ] The full workflow of "Eating a vegetarian meal" is implemented (0.2)
    ...
    * [ ] On closing the client and reopening it, it is able to request the data from the server and show it to the user. (0.1)
...
### Scrumboard (0.5)
* [ ] There is a scrum board with a "backlog” and “done” (0.3)
...
* [ ] *Checkstyle is being used perfectly (less than 5 warnings and every suppressed warning has a good reason) (0.2)*
...
### Organisation
* [ ] Certain things are added to the README of the repository before the end of the first week (0.1) 
...
### Process
* [ ] Correct commit messages are self-explanatory (0.1)
...
* [ ] Custom CI configuration, which runs tests and checkstyle has been set up for at least 2 weeks of the project (0.2)

##### Code Reviews
* [ ] *An example of a relatively large PR is given that follows best practices. (Code review, approvals, waiting for CI, etc.) (0.2)*
* [ ] *Pull based development is being used for every merge. Master is properly protected (0.3)*
